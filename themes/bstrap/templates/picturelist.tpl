...
*}
            ...
            <div class="col-lg-6">
               ...
               <h2>{t}Picture Gallery{/t}</h2>

               <ul class="list-group">
                  <li class="list-group-item"><span class="badge">{$count}</span>{t}Number of pictures{/t}</li>
               </ul>
               
               {foreach from=$pictures item=picture}
               <div class="panel panel-default">
                  <div class="panel-heading">{$picture->title}</div>
                  <div class="panel-body" style="text-align:center;">
                     <a href="pictures/{$picture->filename}" title="{$picture->title}" class="fancybox">
                        <img src="pictures/{$picture->filename}" alt="{$picture->title}" title="{$picture->title}" style="width:320px;">
                     </a>
                  </div>
               </div>
               {/foreach}
               ...
               <ul class="pagination">
                  {if $page > 1}
                     <li><a href="{$smarty.server.SCRIPT_NAME}?content=picturelist&amp;page=1&amp;showlist={$showlist}&amp;skin={$pmp_theme_css}">&lt;&lt;</a></li>
                     <li><a href="{$smarty.server.SCRIPT_NAME}?content=picturelist&amp;page={$page-1}&amp;showlist={$showlist}&amp;skin={$pmp_theme_css}">&lt;</a></li>
                  {else}
                     <li><a href="#">&lt;&lt;</a></li>
                     <li><a href="#">&lt;</a></li>
                  {/if}
                  {section name="Pages" start=1 loop=$pages+1}
                     {if ( $smarty.section.Pages.index == 1 ) || ( $page == $smarty.section.Pages.index - 3 ) || ( $page == $smarty.section.Pages.index - 2 ) || ( $page == $smarty.section.Pages.index - 1 ) || ( $page == $smarty.section.Pages.index ) || ( $page == $smarty.section.Pages.index + 1 ) || ( $page == $smarty.section.Pages.index + 2 ) || ( $page == $smarty.section.Pages.index + 3 ) || ( $smarty.section.Pages.index == $pages )}
                        ...
                        {else}
                           <li><a href="{$smarty.server.SCRIPT_NAME}?content=picturelist&amp;page={$smarty.section.Pages.index}&amp;showlist={$showlist}&amp;skin={$pmp_theme_css}">{$smarty.section.Pages.index}</a></li>
                        {/if}
                  ...
                  {if $page < $pages}
                     <li><a href="{$smarty.server.SCRIPT_NAME}?content=picturelist&amp;page={$page+1}&amp;showlist={$showlist}&amp;skin={$pmp_theme_css}">&gt;</a></li>
                     <li><a href="{$smarty.server.SCRIPT_NAME}?content=picturelist&amp;page={$pages}&amp;showlist={$showlist}&amp;skin={$pmp_theme_css}">&gt;&gt;</a></li>
                  {else}
                     <li><a href="#">&gt;</a></li>
                     <li><a href="#">&gt;&gt;</a></li>
                  {/if}
